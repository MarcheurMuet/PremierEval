...
public class FormaConnect {
	...
	private static final Logger logger = Logger.getLogger(FormaConnect.class.getName());
	
	private FormaConnect() {
		try {
			getConfigFile();								
	...
	public static synchronized Connection getConnection() {	
		if(connection == null) 	new FormaConnect();
		return connection;
	}
